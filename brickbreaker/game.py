...
ttk.Label(mainframe, text="do you want to edit a level 1=editor 0=startgame").grid(column=1, row=1)
...
if v1 > 1:
	v1 = 0 
	print("\nYou've entered a number above 1 so we set it to 0 for you:")
elif v1 == 0:
	v1 = 0
	print("\neditor off")
elif v1 == 1:
